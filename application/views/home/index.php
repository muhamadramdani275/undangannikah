...
<section class="container-fluid gallery animasi" id="gallery">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 d-flex justify-content-center">
            <a class="venobox wedding-video" data-autoplay="true" data-vbtype="video" href="https://youtu.be/iwlz7CPzqNc" /><i class="fas fa-play"></i></a>
        </div>
    </div>
</section>
...
<script>
    ...
    function initMap() {
        ...
        const contentString =
            ...
            "Link lokasi : <a href='https://goo.gl/maps/viM4ovPQUcwTNaZ88' target='_blank'/>klik disini!</a>" +
            "</div>" +
            "</div>";
